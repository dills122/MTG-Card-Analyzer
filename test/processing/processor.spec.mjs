...
import processorModule from "../../src/processor/index.js";
import imageProcessing from "../../src/image-processing/index.js";
import FileIO from "../../src/file-io.js";
import fuzzyMatching from "../../src/fuzzy-matching/index.js";
import matcher from "../../src/matcher/index.js";
import NeedsAttention from "../../src/models/needs-attention.js";
import Collection from "../../src/models/card-collection.js";
import rds from "../../src/rds/index.js";
import scryfallApi from "../../src/scryfall-api/index.js";
...
describe("Integration::", () => {
    ...
    beforeEach(() => {
        stubs.ImageProcessorCreateStub = sandbox
            .stub(ImageProcessor, "create")
            .returns(ImageProcessorInstance);
        ...
        stubs.GetAdditionalCardInfoStub = sandbox
            ...
            .callsArgWith(2, null, {
                ...
                related_uris: {
                    ...
                    mtgtop8:
                        "https://mtgtop8.com/search?MD_check=1\u0026SB_check=1\u0026cards=Pacifism"
                },
                purchase_uris: {
                    tcgplayer:
